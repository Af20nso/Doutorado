...
\ifdefined\thmcolor
\declaretheoremstyle[
  shaded={bgcolor=\thmcolor,%{gray}{0.95},
  %margin=4pt,
  %textwidth={\linewidth-4pt}
  }
]{plain}
\else
\fi
...
\declaretheorem[style=noital,sibling=theorem,name=Strategy]{strategy}
\declaretheorem[style=noital,sibling=theorem,name=Strategies]{strategies}
% Non Numbered Versions
